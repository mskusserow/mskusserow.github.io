var humanScore = 0;// Create a variable humanScore. Give it a value of the number 0.
var computerScore = 0;// Create a variable computerScore. Give it a value of the number 0.
...
console.log ("The bot has " + computerScore + " point(s).");
